...
exports.validateAppMemory = function(memorySize) {
  if (!memorySize || memorySize < 256 || memorySize > 10240) {
    return g.f('Specify a number between 256 and 10240');
  }
  return true;
};
...
exports.validateAppInstances = function(appInstances) {
  if (appInstances < 1 || appInstances > 10) {
 ...
 * @param {String} hostName Hosting domain name of the app
 * @returns {String|Boolean}
 */
 ...
 * @param {Number} diskQuota Size of app memory
 * @returns {String|Boolean}
 */
exports.validateAppDiskQuota = function(diskQuota) {
  if (!diskQuota || diskQuota < 1024 || diskQuota > 10240) {
    return g.f('Specify a number between 1024 and 10240');
  }
  return true;
};

/**
 * Validate yes or no answer
 * @param {String} answer Size of app memory
 * @returns {String|Boolean}
 */
exports.validateYesNo = function(answer) {
  answer = answer.toLowerCase();
  if (answer !== 'yes' && answer !== 'no') {
    return g.f('Valid options are "yes" or "no"');
  }
  return true;
};
